...
+ OpenCodeList-Dokumente können gegen das [OpenCodeList Document Schema](https://github.com/openpotato/opencodelist/blob/main/schemas/v0.4/schema.json) validiert werden.
